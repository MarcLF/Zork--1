...
void World::CreateWorld()
{
	...
	//Cash
	Item1.push_back(new Item("cash", "A hundred bucks.", Room1[2], false, false, 0));
	//Key
	Item1.push_back(new Item("key", "An old rusty key.", Room1[13], false, false, 0));
	//Gloves
	Item1.push_back(new Item("mail Gloves", "A Heavy rough pair of mail guantlets.", Room1[4], false, false, 0));
	//Bag
